...
def load_comprehensive_data(csv_path='../data/scraped_euromillions_results.csv'):
...
def train_improved_model():
    ...
    print("\\nModel saved as 'lottery_model.keras'")
...
def generate_prediction(model_path='lottery_model.keras', data_path='../data/euromillions_historical_results.csv'):
